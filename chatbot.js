...
//Questions and responses
    else if (questionNum == 1 & input === "Yes" || input === "Sure" || input === "yes" || input === "sure") {
    ...
    else if (questionNum == 1 & input === "No" || input === "Nope" || input === "no" || input === "nope") {
    ...
    else if (questionNum == 2 & input === "Alright, show me some memes" || input === "Ok" || input === "Show memes" || input === "ok" || input === "show memes" || input === "alright, show me some memes") {
      output.innerHTML = 'Then here, click on the button below and enjoy the memes!';
      document.getElementById("button").removeAttribute("hidden");
      document.getElementById("input").value ="";
    }
    else if (questionNum == 1 & input === "You're stupid" || input === "Fudge off" || input === "I hate you" || input === "you're stupid" || input === "fudge off") {
      output.innerHTML = "Please don't be mean... I just want you to have a good time, y'know? :( Wanna look at some memes?";
      document.getElementById("input").value ="";
    }
    else if (questionNum == 1 & input === "I love you" || input === "You're the best" || input === "You're awesome" || input === "you're the best" || input === "you're awesome") {
